...
// const { search } = require('../../../../interactiveLecture/week6/automation-demo/google/search')
...
test('I can search Google', async () => {
    ...
    await searchBar.sendKeys('Rocket Power\n')
    ...
    await searchBar.sendKeys('Chocolate Skateboards\n')
